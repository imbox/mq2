...
class Message {
  ...
  ack() {
    ...
    this.acked = true
    this[kConsumeChannel].ack(this.originalMessage)
  }
  ...
  nack() {
    ...
    this.acked = true
    this[kConsumeChannel].nack(this.originalMessage, false, true)
  }
  ...
  reject() {
    ...
    this.acked = true
    this[kConsumeChannel].nack(this.originalMessage, false, false)
  }

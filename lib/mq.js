...
class Mq2 extends EventEmitter {
  ...
  async configure ({ socketTimeout, connectTimeout } = {}) {
    const timeout = socketTimeout ?? this.topology.socketOptions?.timeout ?? 5e3
    const connTimeout = connectTimeout ?? 2 * timeout
